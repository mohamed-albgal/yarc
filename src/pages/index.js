...
import h1 from    "../assets/img/headshot1.jpg"
import bay from     "../assets/img/headshot2.jpg"
...
import jambiya from "../assets/img/jambiyyahs.jpg"
                ...
                <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                  <div className="pr-0">
                    ...
                    <p className="mt-4 text-lg sm:text-base text-gray-300">
                      The Yemeni American Resource Center is committed to providing a source of learning and growth for the entire
